...
return(<>
    <main className=' md:w-4/5 md:m-auto'>
        ...
        <div className='sm:grid sm:grid-cols-2 sm:gap-3  md:flex md:justify-between'>
            <div className='md:w-img mb'>
        ...
        <section className='mb-5'>
            ...
            <div className='gap-2 sm:grid sm:grid-cols-2 md:flex md:justify-between'>
            <div className={`${style.img3w} md:w-1/3 `} style={{backgroundImage:`url("${img.header}")`,backgroundSize:'Cover',backgroundPosition:'Center Center'}}>
            ...
            <div className={`${style.img3w} md:w-1/3 `} style={{backgroundImage:`url("${img.img6}")`,backgroundSize:'Cover',backgroundPosition:'Center Center'}}>
                <div className={style.minlayer}>
            ...
            <div className={`${style.img3w} md:w-1/3 `} style={{backgroundImage:`url("${img.img7}")`,backgroundSize:'Cover',backgroundPosition:'Center Center'}}>
                <div className={style.minlayer}>
